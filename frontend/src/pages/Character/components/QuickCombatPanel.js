...
import { calcularDefesaTotal } from '../../../data/constants/index';
                                        ...
                                        <FormControl fullWidth size="small">
                                            ...
                                            >
                                                ...
                                                {armadurasDisponiveis.map((arm, idx) => (
                                                    <MenuItem key={idx} value={arm.name}>{arm.name} (+{arm.defesa || arm.bonusDefesa || 0})</MenuItem>
                                                ))}
                                            </Select>
                                        </FormControl>
                                    </Grid>
                                        ...
                                        <FormControl fullWidth size="small">
                                            ...
                                            >
                                                ...
                                                {escudosDisponiveis.map((esc, idx) => (
                                                    <MenuItem key={idx} value={esc.name}>{esc.name} (+{esc.defesa || esc.bonusDefesa || 0})</MenuItem>
                                                ))}
                                            </Select>
                                        </FormControl>
                                    </Grid>
